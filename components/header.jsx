...
export default function Header() {
    return (
      <div className="py-20 px-8 text-center">
        ...
        <p className="lg:text-base md:text-2xl font-bold tracking-[0.3em] uppercase text-black">
          Earrings by Zara
        </p>
        <p className="pt-8 lg:text-[16px] md:text-base max-w-5xl mx-auto leading-relaxed text-black">
